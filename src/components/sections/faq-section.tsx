        ...
        >
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent className="text-muted-foreground text-base leading-relaxed">
                Nossa equipe comercial está comprometida em oferecer agilidade. Solicitações enviadas via formulário detalhado são respondidas em até 15 minutos. Para demandas ainda mais urgentes, nosso canal de Cotação Rápida via WhatsApp oferece atendimento praticamente imediato durante o horário comercial.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </motion.div>
