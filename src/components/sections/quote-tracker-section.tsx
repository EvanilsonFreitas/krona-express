      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Tabs defaultValue="cotacao" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8 h-14 bg-muted/50 p-1">
            <TabsTrigger 
              value="cotacao" 
              className="text-base font-bold h-full data-[state=active]:bg-primary data-[state=active]:text-primary-foreground transition-all rounded-md"
            >
          ...
          <TabsContent value="cotacao" className="focus-visible:outline-none focus-visible:ring-0">
            <Card className="shadow-lg border-border/50">
              <CardHeader className="bg-slate-50 dark:bg-slate-900 rounded-t-xl border-b pb-6">
              ...
              <CardContent className="pt-6">
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="pt-6 flex flex-col items-center gap-4">
                    <Button type="submit" size="lg" className="w-full md:w-auto h-14 px-12 text-lg font-bold shadow-md hover:shadow-lg transition-all">
                      <DeliveryTruck01Icon className="mr-2 w-5 h-5" /> Solicitar Cotação Operacional
                    </Button>
                    <Button asChild variant="outline" size="lg" className="w-full md:w-auto h-12 px-8 font-bold border-green-600 text-green-600 hover:bg-green-50 dark:hover:bg-green-950">
                      <Link href="https://wa.me/551140000000?text=Ol%C3%A1%21+Gostaria+de+solicitar+uma+cota%C3%A7%C3%A3o+r%C3%A1pida+de+frete+com+a+Krona+Express." target="_blank" rel="noopener noreferrer">
                        Prefere cotar via WhatsApp? Clique aqui
                      </Link>
                    </Button>
                    <span className="text-sm font-medium text-muted-foreground flex items-center gap-2">
                      <Call02Icon className="w-4 h-4 text-primary" /> Retorno da equipe comercial em até 2 horas úteis.
                    </span>
                  </div>
                </form>
              </CardContent>
          ...
          <TabsContent value="rastreamento" className="focus-visible:outline-none focus-visible:ring-0">
            <Card id="rastreamento" className="shadow-lg border-border/50">
              <CardHeader className="bg-slate-50 dark:bg-slate-900 rounded-t-xl border-b pb-6">
